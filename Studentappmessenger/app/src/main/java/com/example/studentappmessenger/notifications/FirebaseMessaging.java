package com.example.studentappmessenger.notifications;
...
if(notificationType!=null && notificationType.equals("PostNotification")){
    ...
    private void showPostNotification(String pId, String pTitle, String pDescription) {
        ...
        //Change to our icon dont forget dont forget dont forget
        Bitmap largeIcon= BitmapFactory.decodeResource(getResources(), R.drawable.ic_action_pic);
        Uri notificationSoundUri= RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION);
         NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this,""+ADMIN_CHANNEL_ID)
                 .setSmallIcon(R.drawable.ic_action_pic)
